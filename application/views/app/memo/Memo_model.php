...
class Memo_model extends CI_Model
{
	...
	function getAllMemo()
	{
		...
		{
			$query = $this->db->query("SELECT * FROM `memo` WHERE expire IN ('0','2') ORDER BY `memo`.`no_memo`  DESC");
		}
	...
	{
		$query 	= $this->db->query("SELECT COUNT(nama) as memo FROM `memo` WHERE status <> totapp AND status_app0 = '0' AND status_app1 = '0' AND status_app2 = '0' AND status_app3 = '0' AND status_app4 = '0' ");
		return $query->result_array();
	}
	function countMemoApproved()
	{
		$query 	= $this->db->query("SELECT COUNT(nama) as memo FROM `memo` WHERE status_app0 = '0' AND status_app1 = '0' AND status_app2 = '0' AND  status_app3 = '0' AND  status_app4 = '0' AND status = totapp AND expire IN ('0','2')");
		return $query->result_array();
	}
	...
	function countNotification()
	{
		...
		if($level == 'QC' OR $level == 'R&D')
		{
			$query 	= $this->db->query("SELECT COUNT(nama) as notif FROM `memo` WHERE 
				status <> totapp AND status_app0 = '0' AND status_app1 = '0' AND status_app2 = '0' AND status_app3 = '0'  AND app0 = '1' AND app_qc = '$nama' OR
				status <> totapp AND status_app0 = '0' AND status_app1 = '0' AND status_app2 = '0' AND status_app3 = '0' AND app0 = '1' AND app_rnd = '$nama'");
		}
		elseif($level == 'PRODUKSI')
		{
			$query 	= $this->db->query("SELECT COUNT(nama) as notif FROM `memo` WHERE 
					status <> totapp AND status_app1 = '0' AND status_app2 = '0' AND  status_app3 = '0' AND app1 = '1' AND app2 = '1' AND app_produksi = '$nama' OR 
					status <> totapp AND status_app1 = '0' AND status_app2 = '0' AND  status_app3 = '0' AND app1 = '1' AND app2 = '0' AND app_produksi = '$nama' OR
					status <> totapp AND status_app1 = '0' AND status_app2 = '0' AND  status_app3 = '0' AND app1 = '0' AND app2 = '1' AND app_produksi = '$nama' OR 
					status <> totapp AND status_app1 = '0' AND status_app2 = '0' AND  status_app3 = '0' AND app1 = '0' AND app2 = '0' AND app_produksi = '$nama'");
		}
		elseif($level == 'ACCOUNTING')
		{
			$query 	= $this->db->query("SELECT COUNT(nama) as notif FROM `memo` WHERE 
					status <> totapp AND status_app1 = '0' AND status_app2 = '0' AND  status_app3 = '0' AND status_app3 = '0' AND 
		...
		{
			$query 	= $this->db->query("SELECT COUNT(nama) as notif FROM `memo` WHERE 
					NOT status = totapp AND app_ppic = '$nama' AND status_app0 = '0' AND status_app1 = '0' AND status_app2 = '0' AND status_app3 = '0' 
					");
		}
		return $query->result_array();
	}
	...
	function getViewNotification()
	{
		...
		{
			$query = $this->db->query("SELECT * FROM `memo` WHERE 
					status <> totapp AND status_app1 = '0' AND status_app2 = '0' AND  status_app3 = '0' AND 
					app1 = '1' AND app2 = '1' AND app3 = '1' AND app_acc = '$nama' OR 
					status <> totapp AND status_app1 = '0' AND status_app2 = '0' AND  status_app3 = '0' AND 
					app1 = '1' AND app2 = '1' AND app3 = '0' AND app_acc = '$nama' OR 
					status <> totapp AND status_app1 = '0' AND status_app2 = '0' AND  status_app3 = '0' AND 
		...
		{
			$query 	= $this->db->query("SELECT * FROM `memo` WHERE 
					NOT status = totapp AND app_ppic = '$nama' AND status_app0 = '0' AND status_app1 = '0' AND status_app2 = '0' AND status_app3 = '0' ORDER BY `memo`.`id` DESC");
		}
		return $query->result_array();
	}
