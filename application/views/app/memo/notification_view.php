        ...
        <div class="actions">
                ...
                <div class="dropdown actions__item">
                    ...
                    <div class="dropdown-menu dropdown-menu-right">
                        <a href="<?php echo base_url() ?>memo/notification" class="dropdown-item">Refresh</a>
                    </div>
                </div>
            </div>
    </header>
    ...
    <div class="card">
        <div class="card-header"> 
            ...
            <!-- <div class="alert alert-sm alert-success alert-dismissible fade show fade-in">
                ...
                <a>Anda memiliki <?php echo $notif; ?> memo untuk dilihat. <br>Untuk melihat daftar semua memo dapat dilakukan pada halaman berikut:&nbsp; <small><a class="text-danger" href="<?php echo base_url() ?>memo"><b><u>Lihat Memo</u></b></a></small></a>
            </div>  -->  
        </div>
                 ...
                 <table id="data-table" class="table table-striped">
                    <thead class="thead-default">
                        <tr>
                            ...
                            <td><a>Nama Memo</a></td>
                            <td><a>Kepada</a></td>
                            <?php if($this->session->userdata('section') == 'PPIC' OR $level == 'Super Admin' OR $level == 'PRODUKSI')
                            {
                                echo "<td align='center'><a>Dibuat Oleh</a></td>";
                            }
                            if($level != 'User')
                            {
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <?php if($this->session->userdata('section') == 'PPIC' OR $level == 'Super Admin' OR $level == 'PRODUKSI')
                            {
                                echo "<td><a class='btn btn btn-sm'>".$dibuat."</td>";
                            }                                
                            if($level != 'User')
                            {
                            ...
                            <th align='center'>
                                ...
                                <?php } ?>
                                    ...
                                    <?php } else{} } ?>
                                    <?php if($this->session->userdata('section') == 'PL 1 LAMINASI') { ?>
                                    <div>
                                        <a onclick="return confirm('Apakah anda yakin?')" href="<?php echo base_url().'memo/finishing/'.$id.'/'.$segment; ?>" data-toggle="popover" data-placement="top" data-trigger="hover" data-content="Done?" class="btn btn-sm bg-blue-grey text-white">
                                        <i class="zmdi zmdi-check-circle"></i> Selesai
                                        </a>&nbsp;&nbsp; 
                                    </div>
                                    <?php } ?>
                                </div>
