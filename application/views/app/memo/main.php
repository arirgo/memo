<section class="content">
    ...
    <div class="card">
        <div class="card-header">
            ...
            <?php echo $this->session->flashdata('finish'); ?>
                        ...
                        <tr>
                            ...
                            if($level != 'User')
                            {
                                ...
                                { 
                                    if($sys_apprv == '1')
                                    {    
                                        echo "<td align='center'><a class='btn btn-success btn-sm text-white'>APPROVED: SYSTEM APPROVE</a></td>";
                                    } else {
                                        echo "<td align='center'><a class='btn btn-success btn-sm text-white'>APPROVED: ".$appprod."</a></td>";
                                    }
                                    echo "<td align='center'><a align='center' class='btn btn-secondary btn-sm'>".$tgl_app3."</a></td>"; 
                                }
                                else
                                {
                                    echo "<td align='center'><a class='btn btn-sm'>TIDAK ADA APPROVAL</a></td>
                            ...
                            <th align='center'>
                                <div class="row">
                                    <?php if($app0 == '2' AND $app_ppic == $nama OR 
                                            ...
                                            $app4 == '2' AND $appacc == $nama OR
                                            $app3 == '2' AND $level == 'Super Admin') { ?>
                                    <div>
