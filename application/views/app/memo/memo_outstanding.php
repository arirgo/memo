<section class="content">
    ...
    <div class="card">
        <div class="card-header">
            ...
            <!-- <h2 class="card-title">Memo Outstanding</h2> -->
                        ...
                        <tr>
                            ...
                            <th align='center'>
                                ...
                                <?php } ?>
                                    ...
                                    <?php } else{} } ?>
                                    <?php
                                    if ($app_ppic == $nama AND $app0 == '1' OR $appqc == $nama AND $app1 == '1' OR $apprnd == $nama AND $app2 == '1' OR $appprod == $nama AND $app3 == '1') {
                                        ?>  
                                    <div>
