...
$(window).on("load", function() {
    ...
    if ($(".btn")[0] && (Waves.init(), Waves.attach(".btn")), $("#data-table")[0]) {
        $("#data-table").DataTable({
            ...
            lengthMenu: [
                [10, 30, 45, -1],
                ["10 Rows", "30 Rows", "45 Rows", "Everything"]
            ],
            language: {
                searchPlaceholder: "Search for memo..."
            },
            dom: "Blfrtip",
            buttons: [{
                extend: "excelHtml5",
            ...
            initComplete: function(a, b) {
                $(this).closest(".dataTables_wrapper").prepend('<div class="dataTables_buttons hidden-sm-down actions"><span class="actions__item zmdi zmdi-fullscreen" data-table-action="fullscreen" /><div class="dropdown actions__item"><i data-toggle="dropdown" class="zmdi zmdi-download" /><ul class="dropdown-menu dropdown-menu-right"><a href="" class="dropdown-item" data-table-action="excel">Excel (.xlsx)</a><a href="" class="dropdown-item" data-table-action="csv">CSV (.csv)</a></ul></div></div>')
            }
